...
def _render_python() -> str:
    return """# Code generated by python/tools/generate_jira_sprint_models.py. DO NOT EDIT.
from __future__ import annotations
